# Generated by Django 5.2.3 on 2026-03-29 18:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Nome do período de pagamento', max_length=100, verbose_name='Nome')),
                ('description', models.TextField(blank=True, help_text='Descrição do período de pagamento', verbose_name='Descrição')),
