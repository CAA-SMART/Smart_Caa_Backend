# Generated by Django 5.2.3 on 2026-03-29 19:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Nome do usuário da conta', max_length=100, verbose_name='Nome')),
                ('cpf', models.CharField(help_text='CPF do usuário da conta', max_length=14, unique=True, verbose_name='CPF')),
                ('account', models.ForeignKey(help_text='Conta à qual o usuário pertence', on_delete=django.db.models.deletion.CASCADE, related_name='users', to='management.account', verbose_name='Conta')),
